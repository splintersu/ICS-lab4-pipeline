complete_data = [
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "26" , "val" : "064|0x40"},
		{"addr" : "27" , "val" : "002|0x02"},
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["jne 26" , "xorl ebx,ebx" , "irmovl 1,eax" , "irmovl 10000000,edx" , "EMPTY"],
	"REGVALUE" : 
	{
		"eax" : "        0",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["rmmovl eax,0(edx)" , "jne 26" , "xorl ebx,ebx" , "irmovl 1,eax" , "irmovl 10000000,edx"],
	"REGVALUE" : 
	{
		"eax" : "        0",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["halt" , "rmmovl eax,0(edx)" , "jne 26" , "xorl ebx,ebx" , "irmovl 1,eax"],
	"REGVALUE" : 
	{
		"eax" : "        1",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["halt" , "nop" , "nop" , "jne 26" , "xorl ebx,ebx"],
	"REGVALUE" : 
	{
		"eax" : "        1",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["rmmovl eax,0(edx)" , "halt" , "halt" , "nop" , "nop"],
	"REGVALUE" : 
	{
		"eax" : "        1",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["halt" , "rmmovl eax,0(edx)" , "halt" , "halt" , "nop"],
	"REGVALUE" : 
	{
		"eax" : "        1",
		"ebx" : "        0",
...
,
{
	...
	"MEMORY_TABLE" : [
		...
		{"addr" : "31" , "val" : "000|0x00"},
		{"addr" : "32" , "val" : "000|0x00"}],
"CODE" : ["halt" , "halt" , "rmmovl eax,0(edx)" , "halt" , "halt"],
	"REGVALUE" : 
	{
		"eax" : "        1",
		"ebx" : "        0",
